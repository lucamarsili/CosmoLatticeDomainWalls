...
private:
    ...
    double lambda, eta, mu; //here the only parameters are the self interacting coupling lambda and the vev.
...
// fldS : The actual object which contains the scalar fields.
  ...
  public:
   ...
   ///////// fldS(0_c) is h and fldS(1_c) is a 
    ...
    {
      return 0.25*lambda*pow<2>(pow<2>(abs(fldS(0_c)))-eta*eta);
    }
    ...
    {
        return 1/N_DW*mu*mu*et*eta*(1-abs(fldS(0_c))/eta*cos(N_DW*fldS(1_c)));
    }
